...
import { BoxGeometry, CylinderGeometry, Group, Matrix4, Mesh, MeshPhongMaterial, Object3D, Vector3 } from 'three';
...
export class Rabbit extends LoopWithControls implements HasMesh, Loop {
  ...
  constructor() {
    ...
    class Pilot {
      private mesh: any;
      private pilot: any;
      private earPivotL: any;
      private earPivotR: any;
      private eye: any;
      private eyeb: any;
      ...
      _createPilot() {
        ...
        this.earPivotL.applyMatrix(
          new Matrix4().makeTranslation(0, 2.5, 0)
        );
